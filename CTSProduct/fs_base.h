...
/** 
 * @brief Invalid license. If the return value of calling function is ::FS_ERR_INVALID_LICENSE, please confirm whether it correctly calls ::FS_Library_Unlock function to unlock. If the return value is still ::FS_ERR_INVALID_LICENSE, please contact Foxit at sales@foxitsoftware.com or support@foxitsoftware.com.
 */
...
/**
 * @brief Get data buffer to a DIB
 *
