 ...
 *			The data type of <i>buffer</i> is depended on the parameter <i>infotype</i>,
 ...
 *							The data type of <i>buffer</i> is depended on the parameter <i>infotype</i>.<br>
 ...
 *
 * @details	The data type of the parameter <i>data</i> is depended on the parameter <i>annottype</i>,
...
/**	
 * @brief	Delete the specified annotation off the page
 *
 * @param[in] page			A page handle.
 * @param[in] annot			The annotation handler.
 *
