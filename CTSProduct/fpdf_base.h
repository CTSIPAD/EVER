...
{
	FS_INT32				point_count;	/**< @brief The point count of the pencil line. */
	FS_POINTF*				points;			/**< @brief Points of the line in pencil annotation. */
}FPDF_ANNOT_LINE;
#endif
...
typedef struct _FPDF_ANNOT_PENCILINFO_
{
	...
	FS_INT32				line_width;		/**< @brief The line width of the pencil annotation. */
...
typedef struct _FPDF_ANNOT_LINKINFO_
{
	...
	FS_INT32				opacity;		/**< @brief The opacity of the annotation. */
	FS_RECTF				rect;			/**< @brief The rectangle of the annotation. */
	FPDF_ANNOT_QUAD			quad;			/**< @brief Quadrilaterals of highlight annotation. */
	FS_INT32				line_width;		/**< @brief The line width of pencil annotation. */
