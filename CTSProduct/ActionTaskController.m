...
@synthesize delegate,actions,rectFrame,displayingLabel,sheet,isDestinationSection;
    ...
    else
    {
        if(!isDestinationSection)
            for(destination in self.actions)
            {
                ...
                {
                    NSRange range = [section rangeOfString:searchString options:NSCaseInsensitiveSearch];
